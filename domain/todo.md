...
- [ ] Rules: Structure/identity — `INV-VAL-001..003` — `02:L127-L146`
...
- [ ] Rules: Advance/final — `INV-VAL-070..073` — `02:L315-L341`
...
- [ ] VAT tests: `VAT-001..006` — `03:L7-L39`
...
- [ ] Create project `OpenKSeF.Invoices.Application`
