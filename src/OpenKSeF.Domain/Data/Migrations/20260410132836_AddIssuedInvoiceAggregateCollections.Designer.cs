...
namespace OpenKSeF.Domain.Data.Migrations
{
    ...
    [Migration("20260410132836_AddIssuedInvoiceAggregateCollections")]
    partial class AddIssuedInvoiceAggregateCollections
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenKSeF.Domain.Entities.IssuedInvoiceRecord", b =>
                {
                    ...
                    b.Property<string>("AdvanceDocumentIdsJson")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("DuplicateIssuancesJson")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("SettledAdvanceAllocationsJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("OpenKSeF.Domain.Entities.SyncedInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OpenKSeF.Domain.Entities.SyncedInvoiceLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("SyncedInvoiceId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SyncedInvoiceId")
                        .HasDatabaseName("IX_SyncedInvoiceLines_InvoiceHeaderId");
            ...
            modelBuilder.Entity("OpenKSeF.Domain.Entities.SyncedInvoiceLine", b =>
                {
                    b.HasOne("OpenKSeF.Domain.Entities.SyncedInvoice", "SyncedInvoice")
                        .WithMany("Lines")
                        .HasForeignKey("SyncedInvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_SyncedInvoiceLines_SyncedInvoices_InvoiceHeaderId");

                    b.Navigation("SyncedInvoice");
                });
